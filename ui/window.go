...
func (pw *Visualizer) drawDefaultUI() {
	...
	pw.w.Fill(image.Rect(x-200, y+100, x+200, y-100), color.RGBA{R: 219, G: 208, B: 48, A: 1}, draw.Src)
	pw.w.Fill(image.Rect(x-100, y-200, x+100, y+200), color.RGBA{R: 219, G: 208, B: 48, A: 1}, draw.Src)
